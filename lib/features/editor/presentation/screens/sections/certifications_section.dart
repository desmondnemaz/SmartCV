        ...
        return ExpansionTile(
          ...
          title: ExpandableSectionTitle(
            ...
            onVisibilityToggled: () => provider.updateSectionTitles(
                titles.copyWith(showCertifications: !titles.showCertifications)),
            onSectionRemoved: () => provider.removeSection('certifications'),
          ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            onChanged: (val) { cert.title = val; provider.updateCertification(index, cert); },
                          ),
                          const SizedBox(height: 8),
                          TextFormField(
                            initialValue: cert.issuer,
                            decoration: const InputDecoration(labelText: 'Issuing Organization', isDense: true),
                            onChanged: (val) { cert.issuer = val; provider.updateCertification(index, cert); },
                          ),
                          const SizedBox(height: 8),
                          Row(
                            children: [
                              Expanded(
                                child: TextFormField(
                                  ...
                                  onChanged: (val) { cert.date = val; provider.updateCertification(index, cert); },
                                ),
                              ),
                              ...
                              Column(
                                children: [
                                  ...
                                  Switch(
                                    ...
                                    onChanged: (val) { cert.isCompleted = val; provider.updateCertification(index, cert); },
                                  ),
                                  Text(cert.isCompleted ? 'Completed' : 'In Progress',
                          ...
                          RichTextEditorField(
                            key: ValueKey('cert_$index'),
                            initialValue: cert.description,
                            height: 100,
                            placeholder: 'Additional details...',
                            onChanged: (val) { cert.description = val; provider.updateCertification(index, cert); },
                          ),
                        ],
                      ),
                    ),

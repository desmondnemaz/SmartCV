        ...
        return ExpansionTile(
          ...
          title: ExpandableSectionTitle(
            ...
            onVisibilityToggled: () => provider.updateSectionTitles(
                titles.copyWith(showProjects: !titles.showProjects)),
            onSectionRemoved: () => provider.removeSection('projects'),
          ),
          ...
          children: [
            Column(
              children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            onChanged: (val) { project.title = val; provider.updateProject(index, project); },
                          ),
                          const SizedBox(height: 8),
                          TextFormField(
                            initialValue: project.link,
                            decoration: const InputDecoration(labelText: 'Project Link / URL (Optional)', isDense: true),
                            onChanged: (val) { project.link = val; provider.updateProject(index, project); },
                          ),
                          const SizedBox(height: 8),
                          Row(
                            children: [
                              Expanded(
                                child: TextFormField(
                                  ...
                                  onChanged: (val) { project.startDate = val; provider.updateProject(index, project); },
                                ),
                              ),
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  onChanged: (val) { project.endDate = val; provider.updateProject(index, project); },
                                ),
                              ),
                            ],
                          ),
                          ...
                          RichTextEditorField(
                            ...
                            onChanged: (val) { project.description = val; provider.updateProject(index, project); },
                          ),
                        ],
                      ),
                    ),
                ...
                const SizedBox(height: 8),
                TextButton.icon(
                  onPressed: () => provider.addProject(Project()),
